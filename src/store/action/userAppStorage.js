...
export const checkIfAdminIsLoggedIn = () => {
  ...
  //https://track-admin-backend.onrenderll.com
      response = await fetch(`https://track-backend-wyvn.onrender.com/adminbytoken`, {
        method: "GET",
        headers:{
...
//https://track-backend-wyvn.onrender.com

export const loginAdmin = (data) => {
  let dataObj = data
  return async (dispatch, getState) => {
    try {
      let response = await fetch('https://track-backend-wyvn.onrender.com/adminlogin', {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
...
export const signupAdmin = (data) => {
  ...
  return async (dispatch, getState) => {
    try {
      let response = await fetch(`https://track-backend-wyvn.onrender.com/adminsignup`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
...
export const fetchCossignments = ()=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://track-backend-wyvn.onrender.com/cosignments`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const deleteCossignment = (id)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://track-backend-wyvn.onrender.com/cosignments/${id}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const updateCossignment = (data)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://track-backend-wyvn.onrender.com/cosignments/${data._id}`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const createCossignment = (data)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://track-backend-wyvn.onrender.com/cosignment`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const fetchHistories = (id)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://track-backend-wyvn.onrender.com/histories/${id}`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const deleteHistory = (id)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://track-backend-wyvn.onrender.com/history/${id}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const updateHistory = (data)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://track-backend-wyvn.onrender.com/histories/${data._id}`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const createHistory = (data)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://track-backend-wyvn.onrender.com/history`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const updateAdmin = (data)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://track-backend-wyvn.onrender.com/admin/${data._id}`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const sendEmail = (data)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://track-backend-wyvn.onrender.com/sendemail`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
